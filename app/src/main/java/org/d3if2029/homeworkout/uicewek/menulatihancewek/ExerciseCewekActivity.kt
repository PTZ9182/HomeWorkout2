...
import org.d3if2029.homeworkout.adaptercewek.ExerciseStatusAdapterCewek
import org.d3if2029.homeworkout.dbcewek.ExercisesCewek
...
class ExerciseCewekActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var exerciseList : ArrayList<ExerciseModelCewek>? = null
    private var currentExercisePosition = -1

    private var tts : TextToSpeech? = null
    private var player : MediaPlayer? = null

    private var exerciseAdapter : ExerciseStatusAdapterCewek? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList = ExercisesCewek.defaultExerciseList()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTime*1000, 1000){
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!! - 1){
                    ...
                    finish()
                    val intent = Intent(this@ExerciseCewekActivity, SelesaiLatihanCewekActivity::class.java)
    ...
    private fun setupExerciseStatusRecyclerView(){
        ...
        exerciseAdapter = ExerciseStatusAdapterCewek(exerciseList!!,this)
