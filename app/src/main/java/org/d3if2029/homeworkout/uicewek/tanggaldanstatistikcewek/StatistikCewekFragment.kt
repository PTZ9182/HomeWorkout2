package org.d3if2029.homeworkout.uicewek.tanggaldanstatistikcewek
...
class StatistikCewekFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentStatistikCewekBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dbHelper = SqliteCewek(requireContext(), null)
    ...
    private fun getAllCompletedDates() {
        val dbHandler = SqliteOpenHelperCewek(requireContext(), null)
        ...
        if (::no_data_tv.isInitialized && ::history_rv.isInitialized) {
            if (allCompletedDatesList.isEmpty()) {
                ...
                // SET ADAPTER
                history_rv.layoutManager = LinearLayoutManager(requireContext())
                val historyAdapter = HistoryAdapterCewek(requireContext(), allCompletedDatesList)
                history_rv.adapter = historyAdapter
            }
        }
    }
