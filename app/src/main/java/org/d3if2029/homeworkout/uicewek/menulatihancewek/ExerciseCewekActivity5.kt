...
import org.d3if2029.homeworkout.adaptercewek.ExerciseStatusAdapterCewek5
import org.d3if2029.homeworkout.dbcewek.ExercisesCewek5
import org.d3if2029.homeworkout.entitycewek.ExerciseModelCewek5
import org.d3if2029.homeworkout.ui.menulatihan.SelesaiLatihanActivity
import java.lang.Exception
import java.util.*
import kotlin.collections.ArrayList

class ExerciseCewekActivity5 : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var exerciseList : ArrayList<ExerciseModelCewek5>? = null
    private var currentExercisePosition = -1

    private var tts : TextToSpeech? = null
    private var player : MediaPlayer? = null

    private var exerciseAdapter : ExerciseStatusAdapterCewek5? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList = ExercisesCewek5.defaultExerciseList()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTime*1000, 1000){
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!! - 1){
                    ...
                    finish()
                    val intent = Intent(this@ExerciseCewekActivity5, SelesaiLatihanCewek5Activity::class.java)
    ...
    private fun setupExerciseStatusRecyclerView(){
        ...
        exerciseAdapter = ExerciseStatusAdapterCewek5(exerciseList!!,this)
