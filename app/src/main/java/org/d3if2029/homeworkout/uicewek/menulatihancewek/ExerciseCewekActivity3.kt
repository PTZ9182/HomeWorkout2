...
import org.d3if2029.homeworkout.adaptercewek.ExerciseStatusAdapterCewek3
import org.d3if2029.homeworkout.dbcewek.ExercisesCewek3
...
class ExerciseCewekActivity3 : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var exerciseList : ArrayList<ExerciseModelCewek3>? = null
    private var currentExercisePosition = -1

    private var tts : TextToSpeech? = null
    private var player : MediaPlayer? = null

    private var exerciseAdapter : ExerciseStatusAdapterCewek3? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList = ExercisesCewek3.defaultExerciseList()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTime*1000, 1000){
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!! - 1){
                    ...
                    finish()
                    val intent = Intent(this@ExerciseCewekActivity3, SelesaiLatihanCewek3Activity::class.java)
    ...
    private fun setupExerciseStatusRecyclerView(){
        ...
        exerciseAdapter = ExerciseStatusAdapterCewek3(exerciseList!!,this)
