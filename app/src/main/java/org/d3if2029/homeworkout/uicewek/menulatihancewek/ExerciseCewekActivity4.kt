...
import org.d3if2029.homeworkout.adaptercewek.ExerciseStatusAdapterCewek4
import org.d3if2029.homeworkout.dbcewek.ExercisesCewek4
...
class ExerciseCewekActivity4 : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var exerciseList : ArrayList<ExerciseModelCewek4>? = null
    private var currentExercisePosition = -1

    private var tts : TextToSpeech? = null
    private var player : MediaPlayer? = null

    private var exerciseAdapter : ExerciseStatusAdapterCewek4? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList = ExercisesCewek4.defaultExerciseList()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTime*1000, 1000){
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!! - 1){
                    ...
                    finish()
                    val intent = Intent(this@ExerciseCewekActivity4, SelesaiLatihanCewek4Activity::class.java)
    ...
    private fun setupExerciseStatusRecyclerView(){
        ...
        exerciseAdapter = ExerciseStatusAdapterCewek4(exerciseList!!,this)
