...
class ExerciseStatus9Adapter(val items : ArrayList<Exercise9Model>, val context: Context) : RecyclerView.Adapter<ExerciseStatus9Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : Exercise9Model = items[position]
