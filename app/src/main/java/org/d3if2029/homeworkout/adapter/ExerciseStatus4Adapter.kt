...
class ExerciseStatus4Adapter(val items : ArrayList<Exercise4Model>, val context: Context) : RecyclerView.Adapter<ExerciseStatus4Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : Exercise4Model = items[position]
