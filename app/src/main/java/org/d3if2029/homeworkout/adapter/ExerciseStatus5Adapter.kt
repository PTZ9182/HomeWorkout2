...
class ExerciseStatus5Adapter(val items : ArrayList<Exercise5Model>, val context: Context) : RecyclerView.Adapter<ExerciseStatus5Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : Exercise5Model = items[position]
