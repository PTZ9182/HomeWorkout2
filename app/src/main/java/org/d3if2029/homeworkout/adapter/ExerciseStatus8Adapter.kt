...
class ExerciseStatus8Adapter(val items : ArrayList<Exercise8Model>, val context: Context) : RecyclerView.Adapter<ExerciseStatus8Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : Exercise8Model = items[position]
