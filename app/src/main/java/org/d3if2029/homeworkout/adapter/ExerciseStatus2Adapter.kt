...
class ExerciseStatus2Adapter(val items : ArrayList<Exercise2Model>, val context: Context) : RecyclerView.Adapter<ExerciseStatus2Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : Exercise2Model = items[position]
