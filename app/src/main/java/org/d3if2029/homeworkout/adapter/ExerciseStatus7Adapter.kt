...
class ExerciseStatus7Adapter(val items : ArrayList<Exercise7Model>, val context: Context) : RecyclerView.Adapter<ExerciseStatus7Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : Exercise7Model = items[position]
