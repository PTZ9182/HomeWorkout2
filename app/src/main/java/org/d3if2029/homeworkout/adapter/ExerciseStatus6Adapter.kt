...
class ExerciseStatus6Adapter(val items : ArrayList<Exercise6Model>, val context: Context) : RecyclerView.Adapter<ExerciseStatus6Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : Exercise6Model = items[position]
