...
class ExerciseStatusAdapterCewek5(val items : ArrayList<ExerciseModelCewek5>, val context: Context) : RecyclerView.Adapter<ExerciseStatusAdapterCewek5.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : ExerciseModelCewek5 = items[position]
