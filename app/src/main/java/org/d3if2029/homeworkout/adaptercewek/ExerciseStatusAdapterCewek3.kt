...
class ExerciseStatusAdapterCewek3(val items : ArrayList<ExerciseModelCewek3>, val context: Context) : RecyclerView.Adapter<ExerciseStatusAdapterCewek3.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : ExerciseModelCewek3 = items[position]
