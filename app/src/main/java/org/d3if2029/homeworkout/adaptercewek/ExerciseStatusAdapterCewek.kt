...
class ExerciseStatusAdapterCewek(val items : ArrayList<ExerciseModelCewek>, val context: Context) : RecyclerView.Adapter<ExerciseStatusAdapterCewek.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : ExerciseModelCewek = items[position]
