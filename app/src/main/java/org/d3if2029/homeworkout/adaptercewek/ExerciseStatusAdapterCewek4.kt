...
class ExerciseStatusAdapterCewek4(val items : ArrayList<ExerciseModelCewek4>, val context: Context) : RecyclerView.Adapter<ExerciseStatusAdapterCewek4.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : ExerciseModelCewek4 = items[position]
