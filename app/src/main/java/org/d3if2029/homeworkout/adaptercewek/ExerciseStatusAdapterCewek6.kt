...
class ExerciseStatusAdapterCewek6(val items : ArrayList<ExerciseModelCewek6>, val context: Context) : RecyclerView.Adapter<ExerciseStatusAdapterCewek6.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : ExerciseModelCewek6 = items[position]
