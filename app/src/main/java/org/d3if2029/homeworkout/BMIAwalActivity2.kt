...
import org.d3if2029.homeworkout.databinding.ActivityBmiAwalBinding
import org.d3if2029.homeworkout.databinding.ActivityMenuLatihan2Binding
import org.d3if2029.homeworkout.ui.menulatihan.Exercise5Activity
import java.math.BigDecimal
import java.math.RoundingMode

class BMIAwalActivity2 : AppCompatActivity(){
    val METRIC_UNITS_VIEW = "METRIC_UNIT_VIEW"
    val US_UNITS_VIEW = "US_UNIT_VIEW"

    var currentVisibleView : String = METRIC_UNITS_VIEW
    private lateinit var binding: ActivityBmiAwalBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBmiAwalBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.btnSelesai.setOnClickListener {
            val intent = Intent(this@BMIAwalActivity2, MainActivity3::class.java)
    ...
    private fun displayBMIResult(bmi: Float){
        ...
        if (bmi.compareTo(15f) <= 0) {
            ...
            bmiDescription = "Ups! Anda benar-benar perlu merawat diri sendiri dengan lebih baik! Makan lebih! dan workout pemula"
            ...
            bmiLabel = "Obesitas"
            bmiDescription = "Ups! Anda benar-benar harus menjaga diri sendiri! Workout mungkin! Dari tingkat menengah hingga ahli"
        } else if (bmi.compareTo(30f) > 0 && bmi.compareTo(35f) <= 0) {
            bmiLabel = "Obesitas Tingkat | (Obesitas Sedang)"
            bmiDescription = "Ups! Anda benar-benar harus menjaga diri sendiri! Latihan mungkin! Dari tingkat menengah hingga ahli "
        } else if (bmi.compareTo(35f) > 0 && bmi.compareTo(40f) <= 0) {
            bmiLabel = "Obesitas Tingkat || (Obesitas Parah)"
            bmiDescription = "YA AMPUN! Anda berada dalam kondisi yang sangat berbahaya! bertindak sekarang! Dari tingkat menengah hingga ahli"
        } else {
