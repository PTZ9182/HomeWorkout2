...
import org.d3if2029.homeworkout.adapter.ExerciseStatus9Adapter
import org.d3if2029.homeworkout.db.Exercises9
import org.d3if2029.homeworkout.entity.Exercise9Model
import java.lang.Exception
import java.util.*
import kotlin.collections.ArrayList

class Exercise9Activity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var exerciseList : ArrayList<Exercise9Model>? = null
    private var currentExercisePosition = -1

    private var tts : TextToSpeech? = null
    private var player : MediaPlayer? = null

    private var exerciseAdapter : ExerciseStatus9Adapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList = Exercises9.defaultExerciseList()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTime*1000, 1000){
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!! - 1){
                    ...
                    finish()
                    val intent = Intent(this@Exercise9Activity, SelesaiLatihan3Activity::class.java)
    ...
    private fun setupExerciseStatusRecyclerView(){
        ...
        exerciseAdapter = ExerciseStatus9Adapter(exerciseList!!,this)
