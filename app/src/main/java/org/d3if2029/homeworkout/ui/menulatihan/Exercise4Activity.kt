...
import org.d3if2029.homeworkout.adapter.ExerciseStatus4Adapter
import org.d3if2029.homeworkout.db.Exercises4
import org.d3if2029.homeworkout.entity.Exercise4Model
import java.lang.Exception
import java.util.*
import kotlin.collections.ArrayList

class Exercise4Activity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var exerciseList : ArrayList<Exercise4Model>? = null
    private var currentExercisePosition = -1

    private var tts : TextToSpeech? = null
    private var player : MediaPlayer? = null

    private var exerciseAdapter : ExerciseStatus4Adapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList = Exercises4.defaultExerciseList()
        setupRestView()
    ...
    private fun setupExerciseStatusRecyclerView(){
        ...
        exerciseAdapter = ExerciseStatus4Adapter(exerciseList!!,this)
